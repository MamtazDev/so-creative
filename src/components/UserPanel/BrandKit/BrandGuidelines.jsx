...
const BrandGuidelines = () => {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => { setIsLoading("done") }, 1000)
  };
...

      {
        ...
        <div className="h-full flex flex-col items-center justify-center">
          ...
          <div className="flex items-center gap-6">
            <button onClick={() => setIsLoading(false)} className="border border-indigo-600 rounded-full py-3 px-6 flex items-center gap-2 text-indigo-600 text-base font-semibold">
