      ...
      <div className="flex items-center gap-4 justify-between mb-6">
        <div className="flex items-center gap-3">
          <div className="relative">
            ...
            <div className="absolute -bottom-1.5 -right-1.5 border-2 border-white w-6 h-6 bg-indigo-600 rounded-full text-white flex items-center justify-center ">
...
// import { plans as PlanData } from "../../../utils/data";
...
//         <div className="flex items-center gap-3">
//           <div className="relative">
//             <img src={require("../../../assets/company-logo.svg")} alt="" />
//             <img
//               className="absolute -bottom-1.5 -right-1.5"
//               src={require("../../../assets/company-edit.svg")}
//               alt=""
//             />
//           </div>
//           <div>
...
//                 navigate(`/user/subscribe/${data.slug}`);
//               }}
//               className="bg-white rounded-full py-1.5 px-4 w-full text-slate-900 text-sm font-semibold"
//             >
//               Upgrade
//             </button>
//           </div>
//         ))}
//       </div>
//       <div className="p-5 border rounded-2xl flex items-start justify-between mb-[53px]">
//         <div>
//           <p className="text-base font-semibold mb-2">
//             Anyone with a example.com can join
//           </p>
...
// //TODO Highlights Optimized code for reducing bundeling
